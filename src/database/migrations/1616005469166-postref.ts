...
export class postref1616005469166 implements MigrationInterface {
    name = 'postref1616005469166'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("createdAt" TIMESTAMP DEFAULT NOW(), "updatedAt" TIMESTAMP DEFAULT NOW(), "id" SERIAL NOT NULL, "firstName" character varying(300) NOT NULL, "lastName" character varying(300) NOT NULL, "phone" character varying(25) NOT NULL, "dateOfBirth" TIMESTAMP WITH TIME ZONE, "gender" "user_gender_enum" NOT NULL, "profileImageId" integer, "cityId" integer, CONSTRAINT "UQ_8e1f623798118e629b46a9e6299" UNIQUE ("phone"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "event" ("createdAt" TIMESTAMP DEFAULT NOW(), "updatedAt" TIMESTAMP DEFAULT NOW(), "id" SERIAL NOT NULL, "title" character varying(350) NOT NULL, "date" date NOT NULL, "startTime" TIMESTAMP NOT NULL, "endTime" TIMESTAMP NOT NULL, "description" character varying(5000) NOT NULL, "totalOfPersons" integer NOT NULL DEFAULT '0', "ownerId" integer, "imageId" integer, "eventLocationId" integer, CONSTRAINT "REL_45e8e0655f148c8ae4dd9d0cc8" UNIQUE ("eventLocationId"), CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`);
