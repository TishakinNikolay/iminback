...
export class PostRefactoring1615211343585 implements MigrationInterface {
    name = 'PostRefactoring1615211343585'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "event" ("createdAt" TIMESTAMP DEFAULT NOW(), "updatedAt" TIMESTAMP DEFAULT NOW(), "id" SERIAL NOT NULL, "title" character varying(350) NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "startTime" TIME NOT NULL, "endTime" TIME NOT NULL, "description" character varying(5000) NOT NULL, "totalOfPersons" integer NOT NULL DEFAULT '0', "ownerId" integer, "imageId" integer, "eventLocationId" integer, CONSTRAINT "REL_45e8e0655f148c8ae4dd9d0cc8" UNIQUE ("eventLocationId"), CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`);
